...
public class OptionsPanel extends JPanel
{
	...
	public OptionsPanel()
	{
		...
		JButton btnLimit = new JButton("Limit field");
		btnLimit.addActionListener(new LimitFieldListener());
		JPanel pActions = createOptionsPanel("actions");
		pActions.add(btnTurn);
		pActions.add(btnReset);
		pActions.add(btnLimit);
	...
	protected class LimitFieldListener implements ActionListener
	{
		...
		public void actionPerformed(final ActionEvent e)
		{
			for (final IOptionsPanelObserver o : observers)
			{
				o.onActionFired(EVisualizerOptions.LIMIT_FIELD, true);
			}
		}
