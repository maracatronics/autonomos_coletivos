...
public final class Sumatra
{
	...
	public static SerialPort		serialPort	= new SerialPort("\\\\\\\\.\\\\COM8"); // novo robo:pegar o numero de com
	public static PrintWriter		writer;															// na painel de
	
	
	// controle/dispositivos e
	// impressora/opensda/propriedade/hardware/hover
	// the curso above first
	...
	static
	{
		...
		try
		{
			...
			serialPort.setParams(SerialPort.BAUDRATE_38400,// novo robo:mudar largura de banda para 38400
					SerialPort.DATABITS_8,
					SerialPort.STOPBITS_1,
					SerialPort.PARITY_NONE);
			writer = new PrintWriter("kicklog.txt", "UTF-8");
