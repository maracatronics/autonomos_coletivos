...
#define DUTY (int)(256 * (1 - 0.9))                        // 0.9 - duty
#define DEN_CHUTE 0.05476458075846455051348017708874       // Define-se o inverso do denominador da regra de 3 do chute para evitar divisões no código visto que divisões em MCUS são lentas => den_chute=(200*3.3)/(4095*div tensao)
