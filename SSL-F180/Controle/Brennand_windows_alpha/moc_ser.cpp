...
QT_MOC_LITERAL(1, 4, 12), // "transmitindo"
QT_MOC_LITERAL(2, 17, 0), // ""
QT_MOC_LITERAL(3, 18, 10) // "procurando"

    },
    "ser\0transmitindo\0\0procurando"
};
...
void ser::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ser *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->transmitindo(); break;
        case 1: _t->procurando(); break;
        default: ;
        }
        ...
        {
            using _t = void (ser::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ser::transmitindo)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (ser::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ser::procurando)) {
                *result = 1;
                return;
            }
        }
