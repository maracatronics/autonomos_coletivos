...
public class FieldPanel extends JPanel implements IFieldPanel
{
	...
	private ELimitField 							limitField			= ELimitField.NONE;
	...
	public enum ELimitField
	{
		...
		private ELimitField(final int side)
		{
			this.side = side;
		}
	...
	public void onOptionChanged(final EVisualizerOptions option, final boolean isSelected)
	{
		...
		switch (option)
		{
			...
			case LIMIT_FIELD:
				...
				{
					case NONE:
						setLimitField(ELimitField.LEFTSIDE);
						break;
					case LEFTSIDE:
						setLimitField(ELimitField.RIGHTSIDE);
						break;
					case RIGHTSIDE:
						setLimitField(ELimitField.NONE);
						break;
				}
				break;
	...
	private void setLimitField(final ELimitField limitField) 
	{
		this.limitField = limitField;
		multiLayer.setLimitField(limitField);
	}
	
	public final ELimitField getLimitField() 
	{
		return limitField;
	}
	/**
