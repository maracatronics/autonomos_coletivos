...
//
//***************************************************************************
class Goleiro implements SendCommand
{
    //===========================================================================
	...
	int			port = 6000;
	String	team = new String("Goleiro");
	...
	try
	    ...
	    {
		System.err.println("");
		System.err.println("USAGE: Goleiro [-parameter value]");
		System.err.println("");
		...
		System.err.println("    team        team_name    Goleiro");
		System.err.println("");
		System.err.println("    Example:");
		System.err.println("      Goleiro -host www.host.com -port 6000 -team Poland");
		System.err.println("    or");
		System.err.println("      Goleiro -host 193.117.005.223");
		return;
	    }

	Goleiro player = new Goleiro(InetAddress.getByName(hostName),
				     port, team);
    ...
    public Goleiro(InetAddress host, int port, String team) 
