...
//
//***************************************************************************
class Gabriel implements SendCommand
{
    //===========================================================================
	...
	int			port = 6000;
	String	team = new String("Gabriel");
	...
	try
	    ...
	    {
		System.err.println("");
		System.err.println("USAGE: Gabriel [-parameter value]");
		System.err.println("");
		...
		System.err.println("    team        team_name    Gabriel");
		System.err.println("");
		System.err.println("    Example:");
		System.err.println("      Gabriel -host www.host.com -port 6000 -team Poland");
		System.err.println("    or");
		System.err.println("      Gabriel -host 193.117.005.223");
		return;
	    }

	Gabriel player = new Gabriel(InetAddress.getByName(hostName),
				     port, team);
    ...
    public Gabriel(InetAddress host, int port, String team) 
